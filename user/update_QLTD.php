...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $approve = ($_SESSION['role'] == 'admin') ? $_POST['approve'] : $data['approve'];
...
<?php else: ?>
    <!-- Nếu không phải admin thì gửi approve hiện tại dưới dạng hidden -->
    <input type="hidden" name="approve" value="<?= $data['approve'] ?>">
<?php endif; ?>


        <button class="btn btn-primary">Lưu</button>
        <a href="QLTD.php" class="btn btn-danger">Hủy</a>
    </form>
</div>
</div>
</div>
